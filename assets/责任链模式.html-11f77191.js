import{_ as s,r as d,o as l,c as a,b as e,d as n,e as v,a as r}from"./app-ec3e5753.js";const u={},t=e("p",null,[e("strong",null,"背景：")],-1),c=e("p",null,"​ 学校规定参加校招的同学必须要请假，且要有相关人员的签字，三天以下需辅导员签字、三到七天需要系主任签字，一个星期以上需要院长签字，更多的则需要校长签字！",-1),m={id:"一、什么是责任链模式",tabindex:"-1"},o=e("a",{class:"header-anchor",href:"#一、什么是责任链模式","aria-hidden":"true"},"#",-1),b={href:"https://so.csdn.net/so/search?q=%E8%B4%A3%E4%BB%BB%E9%93%BE%E6%A8%A1%E5%BC%8F&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},p=r(`<pre><code>职责链可以将请求的处理者组织成一条链，并将请求沿着链传递，如果某个处理者能够处理请求则处理，否则将该请求交由上级处理。客户端只需将请求发送到职责链上，无须关注请求的处理细节，通过职责链将请求的发送者和处理者解耦了，这也是职责链的设计动机。    
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="四、纯的与不纯的责任链模式" tabindex="-1"><a class="header-anchor" href="#四、纯的与不纯的责任链模式" aria-hidden="true">#</a> 四、纯的与不纯的责任链模式：</h3><p>（1）纯的责任链模式要求处理者对象只能在两个行为中选择一个：一是承担责任，二是把责任推给下家，不允许出现某一个具体处理者对象在承担了一部分责任后又把责任向下传的情况。</p><p>（2）在纯的责任链模式里面，请求必须被某一个处理者对象所接收；在不纯的责任链模式里面，一个请求可以最终不被任何接收端对象所接收。</p>`,27);function q(h,g){const i=d("ExternalLinkIcon");return l(),a("div",null,[t,c,e("h3",m,[o,n(" 一、什么是"),e("a",b,[n("责任链模式"),v(i)]),n("：")]),p])}const L=s(u,[["render",q],["__file","责任链模式.html.vue"]]);export{L as default};
