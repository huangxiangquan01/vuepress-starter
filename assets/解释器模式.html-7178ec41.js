import{_ as e,o as n,c as s,a as i}from"./app-5311756c.js";const a={},l=i(`<h3 id="一、什么是解释器模式" tabindex="-1"><a class="header-anchor" href="#一、什么是解释器模式" aria-hidden="true">#</a> 一、什么是解释器模式：</h3><p>​ 解释器模式，就是定义语言的文法，并建立一个解释器来解释该语言中的句子，通过构建解释器，解决某一频繁发生的特定类型问题实例。</p><blockquote><p>​ 这里我们将语言理解成使用规定格式和语法的代码</p></blockquote><pre><code>解释器模式描述了如何构成一个简单的语言解释器，主要应用在使用面向对象语言开发的编译器中，它描述了如何为简单的语言定义一个文法，如何在该语言中表示一个句子，以及如何解释这些句子。
