import{_ as a,o as s,c as n,a as e}from"./app-ec3e5753.js";const t={},i=e(`<h1 id="dashboard" tabindex="-1"><a class="header-anchor" href="#dashboard" aria-hidden="true">#</a> Dashboard</h1><h2 id="dashboard-安装和介绍" tabindex="-1"><a class="header-anchor" href="#dashboard-安装和介绍" aria-hidden="true">#</a> <strong>Dashboard 安装和介绍</strong></h2><h3 id="_1-dashboard-安装" tabindex="-1"><a class="header-anchor" href="#_1-dashboard-安装" aria-hidden="true">#</a> <strong>1 dashboard 安装</strong></h3><p>第一步：安装文件和 image</p><blockquote><p>Dashboard project</p><p>https://github.com/kubernetes/dashboard</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token function">wget</span> <span class="token parameter variable">-y</span>
