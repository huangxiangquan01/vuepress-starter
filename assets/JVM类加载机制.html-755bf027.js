import{_ as n,o as s,c as a,a as e}from"./app-ec3e5753.js";const l={},t=e(`<h1 id="类加载运行全过程" tabindex="-1"><a class="header-anchor" href="#类加载运行全过程" aria-hidden="true">#</a> 类加载运行全过程</h1><p>当我们用java命令运行某个类的main函数启动程序时，首先需要通过类加载器把主类加载到JVM</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Math</span> <span class="token punctuation">{</span>
