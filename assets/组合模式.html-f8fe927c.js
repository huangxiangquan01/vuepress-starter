import{_ as n,o as s,c as a,a as p}from"./app-5311756c.js";const e={},t=p(`<h3 id="一、什么是组合模式" tabindex="-1"><a class="header-anchor" href="#一、什么是组合模式" aria-hidden="true">#</a> 一、什么是组合模式：</h3><pre><code>	组合模式将叶子对象和容器对象进行递归组合，形成树形结构以表示“部分-整体”的层次结构，使得用户对单个对象和组合对象的使用具有一致性，能够像处理叶子对象一样来处理组合对象，无需进行区分，从而使用户程序能够与复杂元素的内部结构进行解耦。
