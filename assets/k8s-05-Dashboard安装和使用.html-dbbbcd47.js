import{_ as a,o as s,c as n,a as e}from"./app-5311756c.js";const t={},i=e(`<h2 id="dashboard-安装和介绍" tabindex="-1"><a class="header-anchor" href="#dashboard-安装和介绍" aria-hidden="true">#</a> <strong>Dashboard 安装和介绍</strong></h2><h3 id="_1-dashboard-安装" tabindex="-1"><a class="header-anchor" href="#_1-dashboard-安装" aria-hidden="true">#</a> <strong>1 dashboard 安装</strong></h3><p>第一步：安装文件和 image</p><blockquote><p>Dashboard project</p><p>https://github.com/kubernetes/dashboard</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token function">wget</span> <span class="token parameter variable">-y</span>
...
kubectl apply <span class="token parameter variable">-f</span> kubernetes-dashboard.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-dashboard-使用" tabindex="-1"><a class="header-anchor" href="#_3-dashboard-使用" aria-hidden="true">#</a> <strong>3.dashboard 使用</strong></h4><p>创建 pod,service,deployment and application</p><p>​</p>`,24),l=[i];function r(p,c){return s(),n("div",null,l)}const d=a(t,[["render",r],["__file","k8s-05-Dashboard安装和使用.html.vue"]]);export{d as default};
